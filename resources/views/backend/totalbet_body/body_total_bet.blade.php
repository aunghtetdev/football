                    ...
                    <div class="bet-card">
                        <div class="d-flex align-items-center">
                            <div class="col-md-3 bet-card-inner">
                                ...
                                <div class="{{ $bet->bet_total_goal == "over" ? 'bet-bg' : 'non-bet-bg' }}">ဂိုးပေါ်</div>
                            </div>
                            ...
                            <div class="col-md-3 bet-card-inner">
                                ...
                                <div class="{{ $bet->bet_total_goal == "under" ? 'bet-bg' : 'non-bet-bg' }}">ဂိုးအောက်</div>
                            </div>
                        ...
                        <div class="row text-white">
                            <div class="col-md-4 offset-md-3">
                                ...
                                <div class="mb-2 mt-1 h3 font-weight-bolder">
                                    <span>ထိုးကြေး : </span>
