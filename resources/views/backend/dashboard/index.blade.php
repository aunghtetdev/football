                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3 class="counter d-inline">{{ $today_bet_amount }} </h3> <span>ks</span>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3 class="counter  d-inline">{{ $total_bet_amount }} </h3> <span>ks</span>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3 class="counter  d-inline">{{ $deposit_amount }}</h3>  <span>ks</span>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3 class="counter  d-inline">{{ $withdraw_amount }}</h3> <span>ks</span>
