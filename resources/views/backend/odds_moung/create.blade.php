        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ url('admin/odds-moung') }}"><span class="badge badge-theme p-2"><i class="fas fa-arrow-left"></i></span></a>
                    Odds Create Page
                </div>
                <form action="{{route('odds-moung.store')}}" method="POST" id="odds-create">
                    @csrf
                    <div class="card-body">
...
$("#get_team").change(function()
{
    ...
    ({
        type: "POST",
        url: "{{url('/admin/match-moung-teams')}}",
        dataType: 'JSON',
